...
module.exports = function (connectOrSession) {
    ...
    CassandraCqlStore.prototype.get = function (sid, callback) {
        this.client.execute(this.getSession, [sid], this.readConsistency, function (err, result) {
            if (err) {
                return callback(err);
            }
    ...
    CassandraCqlStore.prototype.set = function (sid, session, callback) {
        ...
        this.client.execute(cql, [JSON.stringify(session), sid], this.writeConsistency, callback);
    };
    ...
    CassandraCqlStore.prototype.destroy = function (sid, callback) {
        this.client.execute(this.deleteSession, [sid], this.writeConsistency, callback);
    };
